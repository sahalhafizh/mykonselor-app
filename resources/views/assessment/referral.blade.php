<x-layouts.app title="Rujukan">
    <div class="mx-auto" style="max-width:58rem">
        ...
        @else
            <p class="text-muted mb-4">Layanan bantuan dapat diakses berdasarkan kebutuhan Anda. Daftar ini tidak didasarkan pada skor atau kategori hasil individual.</p>
        @endif
